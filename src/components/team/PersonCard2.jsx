...
export default function PersonCard2({ member }) {
  return (
    <div className="flex flex-col md:flex-col lg:flex-row gap-4 lg:gap-6 p-3 lg:p-8 max-w-5xl mx-auto rounded-3xl transform transition-all duration-300 hover:scale-[1.02] hover:shadow-xl" style={{backgroundColor: '#f2f7f5'}}>
      ...
      <div className="flex-shrink-0 w-full md:w-full lg:w-64 max-w-xs sm:max-w-xs md:max-w-sm">
        <div className="bg-gradient-to-br from-custom-700 to-custom-700 rounded-3xl shadow-lg h-60 sm:h-70 md:h-80 lg:h-80 min-h-[280px] lg:min-h-[320px] flex flex-col overflow-hidden p-2 transform transition-all duration-300 hover:shadow-xl">
          <div className="bg-white flex-1 flex items-center justify-center p-0 rounded-2xl relative overflow-hidden group">
            <img 
              src={getCacheBustedUrl(member.image) || "src/assets/teampage/Ritesh photo.jpeg"} 
          ...
          <div className="text-center text-white p-4 transform transition-all duration-300 hover:bg-white/10">
            ...
            <p className="text-custom-700-100 text-sm">{member.role}</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 max-w-xs sm:max-w-xs md:max-w-sm">
        <div className="bg-gradient-to-br from-custom-700 to-custom-700 rounded-3xl p-3 lg:p-6 shadow-lg h-60 sm:h-70 md:h-80 lg:h-80 min-h-[280px] lg:min-h-[320px] flex flex-col transform transition-all duration-300 hover:shadow-xl w-full">
